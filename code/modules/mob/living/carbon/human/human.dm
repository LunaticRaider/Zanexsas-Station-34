...
/mob/living/carbon/human/update_clothing()
	...
	if (src.wear_id)
		src.overlays += image("icon" = 'mob.dmi', "icon_state" = "id")
...
/*	if (src.w_radio)
		...
		if (istype(src.wear_mask, /obj/item/clothing/mask))
			...
			if (!istype(src.wear_mask, /obj/item/clothing/mask/cigarette))
				if (src.wear_mask.blood_DNA)
					var/icon/stain_icon = icon('blood.dmi', "maskblood")
					src.overlays += stain_icon
	...
	if (src.wear_suit)
		...
		if (src.wear_suit.blood_DNA)
			...
			if (istype(src.wear_suit, /obj/item/clothing/suit/armor/vest || /obj/item/clothing/suit/wcoat || /obj/item/clothing/suit/armor/a_i_a_ptank))
				stain_icon = icon('blood.dmi', "armorblood")
			else if (istype(src.wear_suit, /obj/item/clothing/suit/det_suit || /obj/item/clothing/suit/labcoat))
				stain_icon = icon('blood.dmi', "coatblood")
			else
				stain_icon = icon('blood.dmi', "suitblood")
			src.overlays += image("icon" = stain_icon)
	...
	if (src.handcuffed)
		src.pulling = null
		src.overlays += image("icon" = 'mob.dmi', "icon_state" = "handcuff1")
	...
	if (shielded)
		src.overlays += image("icon" = 'mob.dmi', "icon_state" = "shield")
