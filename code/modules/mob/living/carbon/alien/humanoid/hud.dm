...
//end of equippable shit
	...
	mymob.jogar_icon = new /obj/screen(null)
	mymob.jogar_icon.icon = 'screen1_alien.dmi'
	mymob.jogar_icon.icon_state = "act_jogar_off"
	mymob.jogar_icon.name = "jogar"
	mymob.jogar_icon.screen_loc = ui_jogar
	...
	mymob.client.screen += list( mymob.jogar_icon, mymob.zone_sel, mymob.oxygen, mymob.toxin, mymob.fire, mymob.hands, mymob.healths, mymob.pullin, mymob.blind, mymob.flash, mymob.rest, mymob.sleep) //, mymob.mach )
