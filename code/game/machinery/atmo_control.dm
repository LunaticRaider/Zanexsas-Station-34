		...
		if(sensors.len)
			for(var/id_tag in sensors)
				...
				if(data)
					...
					sensor_part = "<FONT colorate='red'>[long_name] can not be found!</FONT><BR>"
...
Rate: [volume_rate] L/sec<BR>"}
				...
				output += "<FONT colorate='red'>ERROR: Can not find input port</FONT> <A href='?src=\ref[src];in_refresh_status=1'>Search</A><BR>"
...
Max Output Pressure: [output_pressure] kPa<BR>"}
				...
				output += "<FONT colorate='red'>ERROR: Can not find output port</FONT> <A href='?src=\ref[src];out_refresh_status=1'>Search</A><BR>"
...
Rate: [volume_rate] L/sec<BR>"}
				...
				output += "<FONT colorate='red'>ERROR: Can not find device</FONT> <A href='?src=\ref[src];refresh_status=1'>Search</A><BR>"
	...
	proc/return_text()
		...
		if(priority_alarms.len)
			for(var/zone in priority_alarms)
				priority_text += "<FONT colorate='red'><B>[zone]</B></FONT>  <A href='?src=\ref[src];priority_clear=[ckey(zone)]'>X</A><BR>"
		else
