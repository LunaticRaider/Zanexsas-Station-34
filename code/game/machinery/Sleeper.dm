...
/obj/machinery/sleep_console/attack_hand(mob/user as mob)
	...
	if (src.connected)
		...
		var/dat = "<font colorate='blue'><B>Occupant Statistics:</B></FONT><BR>"
		if (occupant)
			var/t1
			...
			dat += text("[]\t-Brute Damage %: []</FONT><BR>", (occupant.bruteloss < 60 ? "<font colorate='blue'>" : "<font colorate='red'>"), occupant.bruteloss)
			dat += text("[]\t-Respiratory Damage %: []</FONT><BR>", (occupant.oxyloss < 60 ? "<font colorate='blue'>" : "<font colorate='red'>"), occupant.oxyloss)
			dat += text("[]\t-Toxin Content %: []</FONT><BR>", (occupant.toxloss < 60 ? "<font colorate='blue'>" : "<font colorate='red'>"), occupant.toxloss)
			dat += text("[]\t-Burn Severity %: []</FONT><BR>", (occupant.fireloss < 60 ? "<font colorate='blue'>" : "<font colorate='red'>"), occupant.fireloss)
...
/obj/machinery/sleeper/proc/check(mob/user as mob)
	if (src.occupant)
		...
		user << text("[]\t -Core Temperature: []&deg;C ([]&deg;F)</FONT><BR>", (src.occupant.bodytemperature > 50 ? "<font colorate='blue'>" : "<font colorate='red'>"), src.occupant.bodytemperature-T0C, src.occupant.bodytemperature*1.8-459.67)
