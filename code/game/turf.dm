/turf/DblClick()
	...
	if(usr.stat || usr.restrained() || usr.lying)
		return ..()
	/*
	if(usr.hand && istype(usr.l_hand, /obj/item/weapon/flamejogarer))
		var/turflist = getline(usr,src)
		var/obj/item/weapon/flamejogarer/F = usr.l_hand
		F.flame_turf(turflist)
		..()
	else if(!usr.hand && istype(usr.r_hand, /obj/item/weapon/flamejogarer))
		var/turflist = getline(usr,src)
		var/obj/item/weapon/flamejogarer/F = usr.r_hand
		F.flame_turf(turflist)
		..()
	else
	*/
