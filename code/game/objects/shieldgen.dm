...
/obj/shieldgen/attack_hand(mob/user as mob)
	if (active)
		for(var/mob/viwer in viewers(world.view, src.loc))
			viwer << text("<font colorate='blue'>\icon[] [user] deactivated the shield generator.</font>", src)

		shields_down()

	else
		for(var/mob/viwer in viewers(world.view, src.loc))
			viwer << text("<font colorate='blue'>\icon[] [user] activated the shield generator.</font>", src)
...
/obj/shieldwallgen/attack_hand(mob/user as mob)
	...
	if (!active)
		for(var/mob/O in viewers(world.view, src.loc))
			O << text("<font colorate='blue'>\icon[] [user] activated the shield generator.</font>", src)
		...
		for(var/mob/O in viewers(world.view, src.loc))
			O << text("<font colorate='blue'>\icon[] [user] deactivated the shield generator.</font>", src)
		var/tile
		var/tilepick
		var/xa
		var/ya
