...
/obj/item/weapon/tank/attack_self(mob/user as mob)
	...
	var/message = {"
<b>Tank</b><BR>
<FONT colorate='blue'><b>Tank Pressure:</b> [air_contents.return_pressure()]</FONT><BR>
<BR>
...
/obj/item/weapon/tank/plasma/attackby(obj/item/weapon/W as obj, mob/user as mob)
	...
	if (istype(W, /obj/item/assembly/a_i_a))
		...
		//S = null
		del(S)
// PantsNote: More flamejogarer assembly code. WOO!
	if (istype(W, /obj/item/assembly/w_r_ignite))
		var/obj/item/assembly/w_r_ignite/S = W
		if (!( S.status ))
			return
		var/obj/item/weapon/flamejogarer/R = new /obj/item/weapon/flamejogarer( user )
		R.part1 = S.part1
		S.part1.loc = R
		S.part1.master = R
		R.part2 = S.part2
