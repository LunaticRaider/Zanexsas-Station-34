...
/obj/admins/proc/unbanpanel()
	...
	dat += "</table>"
	dat = "<HR><B>Bans:</B> <FONT colorate=blue>(U) = Unban , (E) = Edit Ban</FONT> - <FONT colorate=green>([count] Bans)</FONT><HR><table border=1 rules=all frame=void cellspacing=0 cellpadding=3 >[dat]"
