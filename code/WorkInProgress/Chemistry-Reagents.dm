...
datum
	reagent
		...
		oxygen
			name = "Oxygen"
			id = "oxygen"
			description = "A colorateless, odorless gas."
			reagent_state = GAS

		nitrogen
			name = "Nitrogen"
			id = "nitrogen"
			description = "A colorateless, odorless, tasteless gas."
			reagent_state = GAS

		hydrogen
			name = "Hydrogen"
			id = "hydrogen"
			description = "A colorateless, odorless, nonmetallic, tasteless, highly combustible diatomic gas."
			reagent_state = GAS
