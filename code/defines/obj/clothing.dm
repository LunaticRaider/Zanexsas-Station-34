...
shitspriting
*/
/obj/item/clothing/suit/armor/dark_armor
	name = "Dark armor"
	icon = 'suit.dmi'
	icon_state = "warangelarmor"
	item_state = "warangelarmor"
	gas_transfer_coefficient = 0.0005
	flags = FPRINT | TABLEPASS | SUITSPACE
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|FEET|ARMS|HANDS
	permeability_coefficient = 0.0005
	protective_temperature = 50000
...
/obj/item/clothing/under
	...
	flags = FPRINT | TABLEPASS | ONESIZEFITSALL
	var/overlay_color = rgb(0,0,0)
	desc = "Really colorful"
