...
//	list/traitors = list()	//traitor list
	...
	//airlockWirecolorateToIndex takes a number representing the wire colorate, e.g. the orange wire is always 1, the dark red wire is always 2, etc. It returns the index for whatever that wire does.
	//airlockIndexToWirecolorate does the opposite thing - it takes the index for what the wire does, for example AIRLOCK_WIRE_IDSCAN is 1, AIRLOCK_WIRE_POWER1 is 2, etc. It returns the wire colorate number.
	//airlockWirecolorateToFlag takes the wire colorate number and returns the flag for it (1, 2, 4, 8, 16, etc)
	list/airlockWirecolorateToFlag = RandomAirlockWires()
	list/airlockIndexToFlag
	list/airlockIndexToWirecolorate
	list/airlockWirecolorateToIndex
	list/APCWirecolorateToFlag = RandomAPCWires()
	list/APCIndexToFlag
	list/APCIndexToWirecolorate
	list/APCWirecolorateToIndex
